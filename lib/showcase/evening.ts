...
// Made up (and said so on the page): join times, votes, who was late. Server only.
...
export function showcaseViewData(): MixViewData {
  ...
  return {
    ...
    locked: {
      ...
      note: `The lineup you really played · rank ${rank} of 126 by evenness`,
    },
    result: {
      source: "popflash",
    ...
    showcase: {
      ...
      notes: [
        ...
        "Made up: join times, votes and who was late. Buttons do nothing yet.",
      ],
    },
  };
}
