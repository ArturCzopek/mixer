...
## D31. Showcase page from one real popflash evening, Accepted (2026-09-25)
Owner wants a link to show the group a real example. `/demo` replays the popflash evening of
16.12.2024 through the real engine (`lib/showcase/`, generated by `backtest/demo-evening.ts` from the
